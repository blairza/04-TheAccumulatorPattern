...
#                  count = 0 (should be outside and before loop)
#                  if math.cos(r) > 0: (r should be k)
#                      count = 1 (count = count + 1)
#                  return count (Should be after and outside the loop)
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean? Variable which increments with the loop
#
