...
def run_test_factorial():
    ...
    answer_from_oracle = math.factorial(109)
    answer_from_my_code = factorial(109)
...
def run_test_count_cosines_from():
    ...
    expected = 7
    answer = count_cosines_from(1, 21, 0.45)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(4, 7, 0.22)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(5, 9, 0.8)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(3, 9, 0.44)
